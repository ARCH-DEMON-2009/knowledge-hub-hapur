            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    to={link.href}
                    className="font-body text-cream text-sm opacity-80 hover:text-gold hover:opacity-100 transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:9917917437" className="font-body text-cream text-sm opacity-80 hover:text-gold hover:opacity-100 transition-colors">9917917437</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-gold shrink-0" />
                <a href="mailto:bijanderk3@gmail.com" className="font-body text-cream text-sm opacity-80 hover:text-gold hover:opacity-100 transition-colors">bijanderk3@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
