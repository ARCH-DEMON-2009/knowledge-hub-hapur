    ...
    <section id="rules" className="py-24 bg-navy relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="font-body text-cream/60 text-lg">A disciplined environment benefits everyone.</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {rules.map((rule, i) => (
            ...
            >
              ...
              <p className="font-body text-cream/60 text-sm leading-relaxed">{rule.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
