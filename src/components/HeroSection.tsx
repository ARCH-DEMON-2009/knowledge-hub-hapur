    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center py-32">
        ...
        <motion.p
          ...
          className="font-body text-lg md:text-xl text-cream max-w-2xl mx-auto mb-4 opacity-95"
        >
        ...
        <motion.p
          ...
          className="font-body text-base text-cream max-w-xl mx-auto mb-10 opacity-85"
        >
